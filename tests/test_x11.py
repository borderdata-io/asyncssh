...
async def _create_x11_process(conn, command=None, x11_display='test:0', **kwargs):
...
class _TestX11(ServerTestCase):
    ...
    async def _check_x11(self, command=None, *, exc=None, exit_status=None, **kwargs):
    ...
    def test_xauth_lookup(self):
        ...
        await update_xauth(asyncio.get_event_loop(), 'xauth',
                                'test', '0', b'', b'\x00')
    ...
    def test_connection_refused_big(self):
        ...
        await self._check_x11('connect B', exit_status=2,
                                   x11_display='test:1')
    ...
    def test_connection_refused_little(self):
        ...
        await self._check_x11('connect l', exit_status=2,
                                   x11_display='test:1')
